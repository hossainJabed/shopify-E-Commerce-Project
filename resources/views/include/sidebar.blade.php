    ...
    <div class="scroll-sidebar">
        ...
        <nav class="sidebar-nav">
            <ul id="sidebarnav">
                ...
                <li>
                    <a class="has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i class="ti-layout-accordion-merged">
                ...
                <li>
                    ...
                    <ul aria-expanded="false" class="collapse">
                        <li><a href="widget-apps.html">List Order</a></li>
                    </ul>
                </li>
                <li>
                    <a class="has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false">
                    ...
                    <ul aria-expanded="false" class="collapse">
                        <li><a href="layout-single-column.html">Create Customer</a></li>
                        <li><a href="layout-fix-header.html">List Customer</a></li>
                    </ul>
                </li>
                <li>
                    <a class="has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i class="ti-files">

                        </i><span class="hide-menu">User Module</span>
                    </a>
                    <ul aria-expanded="false" class="collapse">
                        <li><a href="starter-kit.html">Crate User</a></li>
                        <li><a href="pages-blank.html">List User</a></li>
                ...
                <li>
                    ...
                    <ul aria-expanded="false" class="collapse">
                        <li><a href="chart-morris.html">Create Coupon</a></li>
                        <li><a href="chart-chartist.html">List Coupon</a></li>
                    </ul>
                </li>
                <li>
                    <a class="has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false">
                    ...
                    <ul aria-expanded="false" class="collapse">
                        ...
                        <li><a href="icon-fontawesome.html">Fax Setting</a></li>
