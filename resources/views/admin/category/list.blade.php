              ...
              <div class="table-responsive m-t-40">
                  <table id="myTable" class="table table-striped border">
                      ...
                      <tr>
                          ...
                          <th class="description">Category Description</th>
                          <th class="image">Category Image</th>
                      ...
                      <tr>
                          ...
                          <td><img src="{{asset('uploded/category-file/'.$category->image)}}" alt="" style="height: 50px"></td>
                          <td>
                          ...
                          <td class="action">
                              <a href="{{route('category.edit',$category->id)}}" class="btn btn-sm btn-success"><i class="ti-alert"></i></a>
                              <a href="{{route('category.destroy',$category->id)}}" class="btn btn-sm btn-danger" onclick="return confirm('Are you sure you want to delete this item?');"><i class="ti-trash"></i></a>
                              @if($category->status=='1')
