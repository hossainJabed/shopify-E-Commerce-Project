...
<head>
    ...
    <!-- page css -->
    <link href="{{url('admin')}}/dist/css/pages/login-register-lock.css" rel="stylesheet">
    <!-- Custom CSS -->
...
<!-- ============================================================== -->
<section id="wrapper">
    <div class="login-register" style="background-image:url({{url('admin')}}/assets/images/background/login-register.jpg);">
