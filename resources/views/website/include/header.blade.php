            ...
            <div class="row align-items-center">
                <div class="col-lg-3 col-md-3 col-7">
                    ...
                    <a class="navbar-brand" href="{{route('home')}}">
                        <img src="{{ url('website') }}/assets/images/logo/logo.svg" alt="Logo">
                    </a>
                                    ...
                                    <ul class="shopping-list">
                                        <li>
                                            ...
                                            <div class="cart-img-head">
                                                <a class="cart-img" href="product-details.html"><img src="{{ url('website') }}/assets/images/header/cart-items/item1.jpg" alt="#"></a>
                                            </div>
                                            <div class="content">
                                        ...
                                        <li>
                                            <a href="javascript:void(0)" class="remove" title="Remove this item"><i class="lni lni-close"></i></a>
                                            <div class="cart-img-head">
                                                <a class="cart-img" href="product-details.html"><img src="{{ url('website') }}/assets/images/header/cart-items/item2.jpg" alt="#"></a>
                                            </div>
                                            <div class="content">
