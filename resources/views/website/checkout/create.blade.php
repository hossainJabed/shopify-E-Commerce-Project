                                                ...
                                                <div class="payment-option-wrapper">
                                                    <div class="single-payment-option">
                                                        ...
                                                        <label for="shipping-1">
                                                            <img src="{{ url('website') }}/assets/images/shipping/shipping-1.png" alt="Sipping">
                                                    ...
                                                    <div class="single-payment-option">
                                                        ...
                                                        <label for="shipping-2">
                                                            <img src="{{ url('website') }}/assets/images/shipping/shipping-2.png" alt="Sipping">
                                                            <p>Standerd Shipping</p>
                                                            <span class="price">$10.50</span>
                                                        </label>
                                                    </div>
                                                    <div class="single-payment-option">
                                                        ...
                                                        <label for="shipping-3">
                                                            <img src="{{ url('website') }}/assets/images/shipping/shipping-3.png" alt="Sipping">
                                                            <p>Standerd Shipping</p>
                                                            <span class="price">$10.50</span>
                                                        </label>
                                                    </div>
                                                    <div class="single-payment-option">
                                                        ...
                                                        <label for="shipping-4">
                                                            <img src="{{ url('website') }}/assets/images/shipping/shipping-4.png" alt="Sipping">
                                                            <p>Standerd Shipping</p>
                                                            <span class="price">$10.50</span>
                                                        </label>
                                                    </div>
                                            ...
                                            <div class="checkout-payment-form">
                                                ...
                                                <div class="single-form form-default">
                                                    ...
                                                    <div class="form-input form">
                                                        ...
                                                        <img src="{{ url('website') }}/assets/images/payment/card.png" alt="card">
                                                    </div>
                                                </div>
                    ...
                    <div class="checkout-sidebar">
                        ...
                        <div class="checkout-sidebar-banner mt-30">
                            <a href="product-grids.html">
                                <img src="{{ url('website') }}/assets/images/banner/banner.jpg" alt="#">
                            </a>
                        </div>
                    </div>
                </div>
